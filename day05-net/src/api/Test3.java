 ...
 * ClassName: Test3
 * Package: api
 * Description: BigDecimal 用于解决浮点型运算时，出现结果失真的问题。
 *
 * @Author 白夜
 * @Create 2025/7/22 16:01
 * @Version 1.0
 */
public class Test3 {
...
//        BigDecimal b1 = new BigDecimal(Double.toString(b));
        ...
        // 除法
        //BigDecimal k = i.divide(j);//// 抛异常,除不尽 0.33333333~~~
        BigDecimal k = i.divide(j, 2, RoundingMode.HALF_UP); // 保留两位小数，四舍五入
