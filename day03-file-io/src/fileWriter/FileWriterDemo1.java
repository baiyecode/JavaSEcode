...
//                Writer fw = new FileWriter("day03-file-io/src/baiye07-out.txt"); // 覆盖管道
                Writer fw = new FileWriter("day03-file-io/src/baiye07-out.txt", true); // 追加数据
        ){
            ...
            char[] chars = "java".toCharArray();// 字符串转换成字符数组
            fw.write(chars);
            fw.write("\r\n"); // 换行
